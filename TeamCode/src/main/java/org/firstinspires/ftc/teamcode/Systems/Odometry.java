...
public class Odometry extends System{
    private final double DfCoR = 83,BaseDist = 489, Pi = 2*Math.asin(1), ToMM = 58*Pi/1000, corPrec = 130;//ToMM~.182212
    ...
    public Odometry(DcMotor leftOdom, DcMotor sideOdom, DcMotor rightOdom, DcMotor FL, DcMotor FR, DcMotor BL, DcMotor BR){
        FrontLeft = FL;
        FrontRight = FR;
        BackLeft = BL;
        BackRight = BR;
