...
public class Odometry1 extends System{
    private final double DfCoR = 1, BaseDist = 1375, Pi = 2*Math.asin(1), ToMM = 58*Pi/360, corPrec = 130;
    //279,271,2139
    //466,453,3573
    ...
    public void setScalar(double Scalar){
        driveTrain.setSpeedScalar(Scalar);
    }
    ...
    public void here(){//approcimately .505mm per output unit
